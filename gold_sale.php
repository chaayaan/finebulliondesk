...
if ($isAjax || $action !== null) {
    ...
    if ($action === 'save' && $_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        try {
            ...
            json_out(['success' => false, 'message' => 'Failed to save sale. Please try again.'], 500);
        }

        json_out([
            'success' => true,
            'message' => 'Gold sale saved.',
            'id'      => $saleId,
            'summary' => [
...
<title>Gold Sale — FineBullion Desk</title>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="price-row">
                            <label>Selling Price per Vori (BDT)</label>
...
function formatTrad(t) { return `${t.vori}V ${t.ana}A ${t.roti}R ${t.point}P`; }
function formatBDT(n)  { return '৳' + Math.round(n).toLocaleString('en-BD'); }
...
document.getElementById('saleForm').addEventListener('submit', async function (e) {
    ...
    if (price24k <= 0) { alert('Please enter the pure gold selling price (24k).'); return; }
    ...
    try {
        ...
        btn.disabled = false;
        btn.innerHTML = '<i class="bi bi-check2-circle me-1"></i> Record Sale';
    }
});
</script>
