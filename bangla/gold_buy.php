    ...
    <div class="fb-header">
        <div class="header-title-block">
            <h4 class="mb-1">
                ...
                <span class="d-none d-md-inline">পুরাতন সোনা কেনা</span>
                <span class="d-md-none">পুরাতন সোনা কেনা</span>
            </h4>
            <small class="d-none d-md-inline">কাস্টমারের কাছ থেকে পুরাতন / খাদযুক্ত সোনা ক্রয় করুন</small>
        </div>
        <div class="header-actions">
            <a href="gold_buy_list.php" class="btn btn-fb-secondary btn-sm d-inline-flex align-items-center">
                <i class="bi bi-list-ul me-1"></i> কেনাকাটার হিস্ট্রি
            </a>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header fw-semibold">
                        <i class="bi bi-person-fill me-1"></i> কাস্টমার খুঁজুন
                    </div>
                    <div class="card-body">
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header fw-semibold">
                        <i class="bi bi-coin me-1"></i> পাকা সোনার দাম (২৪ ক্যারেট)
                    </div>
                    <div class="card-body">
                        <div class="price-row">
